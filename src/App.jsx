...
const App = () => {
  ...
  return (
    <>
    <main  className="lg:py-12 py-6 flex flex-col w-full justify-center items-center overflow-hidden"
        style={{
          background:
    ...
    <div className=" lg:p-12 p-2 bg-[#041E23] rounded-[40px] border border-[#0e464f] flex-col justify-center items-center gap-8 flex overflow-hidden w-full md:w-fit">
